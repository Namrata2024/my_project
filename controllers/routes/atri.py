...
class Atri:
	def __init__(self, state: Any):
		...
		self.button_wrapper = state["button_wrapper"]
		self.dwld_csv = state["dwld_csv"]
		self.image = state["image"]
		self.Image1 = state["Image1"]
		self.about_heading = state["about_heading"]
		...
		self.small_content = state["small_content"]
		self.design_line = state["design_line"]
	...
	def button_wrapper(self):
		self._getter_access_tracker["button_wrapper"] = {}
		return self._button_wrapper
	@button_wrapper.setter
	def button_wrapper(self, new_state):
		self._setter_access_tracker["button_wrapper"] = {}
		global default_state
		self._button_wrapper = Flex(new_state, default_state["button_wrapper"])

	@property
	def dwld_csv(self):
		self._getter_access_tracker["dwld_csv"] = {}
		return self._dwld_csv
	@dwld_csv.setter
	def dwld_csv(self, new_state):
		self._setter_access_tracker["dwld_csv"] = {}
		global default_state
		self._dwld_csv = Flex(new_state, default_state["dwld_csv"])
	...
	def image(self, new_state):
		...
		global default_state
		self._image = Flex(new_state, default_state["image"])
	...
	def about_heading(self):
		self._getter_access_tracker["about_heading"] = {}
		return self._about_heading
	@about_heading.setter
	def about_heading(self, new_state):
		self._setter_access_tracker["about_heading"] = {}
		global default_state
		self._about_heading = Link(new_state, default_state["about_heading"])
	...
	def blogs(self, new_state):
		...
		global default_state
		self._blogs = Link(new_state, default_state["blogs"])
	...
	def book(self, new_state):
		...
		global default_state
		self._book = Link(new_state, default_state["book"])
	...
	def small_content(self):
		self._getter_access_tracker["small_content"] = {}
		return self._small_content
	@small_content.setter
	def small_content(self, new_state):
		self._setter_access_tracker["small_content"] = {}
		global default_state
		self._small_content = TextBox(new_state, default_state["small_content"])

	@property
	def design_line(self):
		self._getter_access_tracker["design_line"] = {}
		return self._design_line
	@design_line.setter
	def design_line(self, new_state):
		self._setter_access_tracker["design_line"] = {}
		global default_state
		self._design_line = Image(new_state, default_state["design_line"])
	...
	def _to_json_fields(self):
		return {
			...
			"button_wrapper": self._button_wrapper,
			"dwld_csv": self._dwld_csv,
			"image": self._image,
			"Image1": self._Image1,
			"about_heading": self._about_heading,
			...
			"small_content": self._small_content,
			"design_line": self._design_line,
