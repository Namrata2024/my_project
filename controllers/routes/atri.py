...
class Atri:
	def __init__(self, state: Any):
		...
		self.main_container = state["main_container"]
		...
		self.Trusted_by_heading = state["Trusted_by_heading"]
		self.Flex_trust = state["Flex_trust"]
		self.Flex14 = state["Flex14"]
		self.service_wrapper = state["service_wrapper"]
		self.service_text2 = state["service_text2"]
		...
		self.service_text1 = state["service_text1"]
		self.project_wrapper = state["project_wrapper"]
		self.project_text = state["project_text"]
		self.image_projects = state["image_projects"]
		self.Div8 = state["Div8"]
		self.Div10 = state["Div10"]
		self.Div13 = state["Div13"]
		self.title_projects = state["title_projects"]
		...
		self.blogs_section = state["blogs_section"]
		self.blog_box = state["blog_box"]
		self.Div18 = state["Div18"]
		self.view_all_box = state["view_all_box"]
		self.right_box = state["right_box"]
		self.rightbox_1 = state["rightbox_1"]
		self.read_box = state["read_box"]
		...
		self.arrow_box = state["arrow_box"]
		self.Flex44 = state["Flex44"]
		self.right_arrow_box = state["right_arrow_box"]
		self.left_arrow_box = state["left_arrow_box"]
		self.about_section_1 = state["about_section_1"]
		self.abot_div = state["abot_div"]
		self.about_text = state["about_text"]
		self.left_about = state["left_about"]
		self.about_1_right = state["about_1_right"]
		...
		self.Faq_section&footer = state["Faq_section&footer"]
		...
		self.trusted_by_text = state["trusted_by_text"]
		...
		self.service_text = state["service_text"]
		self.s_text1 = state["s_text1"]
		self.view_btn = state["view_btn"]
		self.project_heading = state["project_heading"]
		...
		self.gr_txt1 = state["gr_txt1"]
		self.TextBox30 = state["TextBox30"]
		self.arrow_1 = state["arrow_1"]
		...
		self.blogs_heading = state["blogs_heading"]
		self.TextBox36 = state["TextBox36"]
		self.white_arrrow = state["white_arrrow"]
		self.TextBox38 = state["TextBox38"]
		self.date_time = state["date_time"]
		self.read_article = state["read_article"]
		self.whie_arrow = state["whie_arrow"]
		...
		self.product_heading = state["product_heading"]
		...
		self.footer_link = state["footer_link"]
	...
	def main_container(self):
		self._getter_access_tracker["main_container"] = {}
		return self._main_container
	@main_container.setter
	def main_container(self, new_state):
		self._setter_access_tracker["main_container"] = {}
		global default_state
		self._main_container = Flex(new_state, default_state["main_container"])
	...
	@property
	def Trusted_by_heading(self):
		self._getter_access_tracker["Trusted_by_heading"] = {}
		return self._Trusted_by_heading
	@Trusted_by_heading.setter
	def Trusted_by_heading(self, new_state):
		self._setter_access_tracker["Trusted_by_heading"] = {}
		global default_state
		self._Trusted_by_heading = Flex(new_state, default_state["Trusted_by_heading"])

	@property
	def Flex_trust(self):
		self._getter_access_tracker["Flex_trust"] = {}
		return self._Flex_trust
	@Flex_trust.setter
	def Flex_trust(self, new_state):
		self._setter_access_tracker["Flex_trust"] = {}
		global default_state
		self._Flex_trust = Flex(new_state, default_state["Flex_trust"])
	...
	@property
	def service_text2(self):
		self._getter_access_tracker["service_text2"] = {}
		return self._service_text2
	@service_text2.setter
	def service_text2(self, new_state):
		self._setter_access_tracker["service_text2"] = {}
		global default_state
		self._service_text2 = Flex(new_state, default_state["service_text2"])
	...
	@property
	def service_text1(self):
		self._getter_access_tracker["service_text1"] = {}
		return self._service_text1
	@service_text1.setter
	def service_text1(self, new_state):
		self._setter_access_tracker["service_text1"] = {}
		global default_state
		self._service_text1 = Flex(new_state, default_state["service_text1"])

	@property
	def project_wrapper(self):
		self._getter_access_tracker["project_wrapper"] = {}
		return self._project_wrapper
	@project_wrapper.setter
	def project_wrapper(self, new_state):
		self._setter_access_tracker["project_wrapper"] = {}
		global default_state
		self._project_wrapper = Flex(new_state, default_state["project_wrapper"])

	@property
	def project_text(self):
		self._getter_access_tracker["project_text"] = {}
		return self._project_text
	@project_text.setter
	def project_text(self, new_state):
		self._setter_access_tracker["project_text"] = {}
		global default_state
		self._project_text = Div(new_state, default_state["project_text"])

	@property
	def image_projects(self):
		self._getter_access_tracker["image_projects"] = {}
		return self._image_projects
	@image_projects.setter
	def image_projects(self, new_state):
		self._setter_access_tracker["image_projects"] = {}
		global default_state
		self._image_projects = Flex(new_state, default_state["image_projects"])
	...
	@property
	def title_projects(self):
		self._getter_access_tracker["title_projects"] = {}
		return self._title_projects
	@title_projects.setter
	def title_projects(self, new_state):
		self._setter_access_tracker["title_projects"] = {}
		global default_state
		self._title_projects = Flex(new_state, default_state["title_projects"])
	...
	@property
	def blogs_section(self):
		self._getter_access_tracker["blogs_section"] = {}
		return self._blogs_section
	@blogs_section.setter
	def blogs_section(self, new_state):
		self._setter_access_tracker["blogs_section"] = {}
		global default_state
		self._blogs_section = Div(new_state, default_state["blogs_section"])

	@property
	def blog_box(self):
		self._getter_access_tracker["blog_box"] = {}
		return self._blog_box
	@blog_box.setter
	def blog_box(self, new_state):
		self._setter_access_tracker["blog_box"] = {}
		global default_state
		self._blog_box = Flex(new_state, default_state["blog_box"])
	...
	@property
	def view_all_box(self):
		self._getter_access_tracker["view_all_box"] = {}
		return self._view_all_box
	@view_all_box.setter
	def view_all_box(self, new_state):
		self._setter_access_tracker["view_all_box"] = {}
		global default_state
		self._view_all_box = Flex(new_state, default_state["view_all_box"])

	@property
	def right_box(self):
		self._getter_access_tracker["right_box"] = {}
		return self._right_box
	@right_box.setter
	def right_box(self, new_state):
		self._setter_access_tracker["right_box"] = {}
		global default_state
		self._right_box = Div(new_state, default_state["right_box"])

	@property
	def rightbox_1(self):
		self._getter_access_tracker["rightbox_1"] = {}
		return self._rightbox_1
	@rightbox_1.setter
	def rightbox_1(self, new_state):
		self._setter_access_tracker["rightbox_1"] = {}
		global default_state
		self._rightbox_1 = Flex(new_state, default_state["rightbox_1"])

	@property
	def read_box(self):
		self._getter_access_tracker["read_box"] = {}
		return self._read_box
	@read_box.setter
	def read_box(self, new_state):
		self._setter_access_tracker["read_box"] = {}
		global default_state
		self._read_box = Flex(new_state, default_state["read_box"])
	...
	@property
	def arrow_box(self):
		self._getter_access_tracker["arrow_box"] = {}
		return self._arrow_box
	@arrow_box.setter
	def arrow_box(self, new_state):
		self._setter_access_tracker["arrow_box"] = {}
		global default_state
		self._arrow_box = Flex(new_state, default_state["arrow_box"])
	...
	@property
	def right_arrow_box(self):
		self._getter_access_tracker["right_arrow_box"] = {}
		return self._right_arrow_box
	@right_arrow_box.setter
	def right_arrow_box(self, new_state):
		self._setter_access_tracker["right_arrow_box"] = {}
		global default_state
		self._right_arrow_box = Div(new_state, default_state["right_arrow_box"])

	@property
	def left_arrow_box(self):
		self._getter_access_tracker["left_arrow_box"] = {}
		return self._left_arrow_box
	@left_arrow_box.setter
	def left_arrow_box(self, new_state):
		self._setter_access_tracker["left_arrow_box"] = {}
		global default_state
		self._left_arrow_box = Div(new_state, default_state["left_arrow_box"])

	@property
	def about_section_1(self):
		self._getter_access_tracker["about_section_1"] = {}
		return self._about_section_1
	@about_section_1.setter
	def about_section_1(self, new_state):
		self._setter_access_tracker["about_section_1"] = {}
		global default_state
		self._about_section_1 = Flex(new_state, default_state["about_section_1"])

	@property
	def abot_div(self):
		self._getter_access_tracker["abot_div"] = {}
		return self._abot_div
	@abot_div.setter
	def abot_div(self, new_state):
		self._setter_access_tracker["abot_div"] = {}
		global default_state
		self._abot_div = Div(new_state, default_state["abot_div"])

	@property
	def about_text(self):
		self._getter_access_tracker["about_text"] = {}
		return self._about_text
	@about_text.setter
	def about_text(self, new_state):
		self._setter_access_tracker["about_text"] = {}
		global default_state
		self._about_text = Flex(new_state, default_state["about_text"])

	@property
	def left_about(self):
		self._getter_access_tracker["left_about"] = {}
		return self._left_about
	@left_about.setter
	def left_about(self, new_state):
		self._setter_access_tracker["left_about"] = {}
		global default_state
		self._left_about = Div(new_state, default_state["left_about"])

	@property
	def about_1_right(self):
		self._getter_access_tracker["about_1_right"] = {}
		return self._about_1_right
	@about_1_right.setter
	def about_1_right(self, new_state):
		self._setter_access_tracker["about_1_right"] = {}
		global default_state
		self._about_1_right = Div(new_state, default_state["about_1_right"])
	...
	@property
	def edu_bo(self):
		self._getter_access_tracker["edu_bo"] = {}
		return self._edu_bo
	@edu_bo.setter
	def edu_bo(self, new_state):
		self._setter_access_tracker["edu_bo"] = {}
		global default_state
		self._edu_bo = Div(new_state, default_state["edu_bo"])
	...
	@property
	def Faq_section&footer(self):
		self._getter_access_tracker["Faq_section&footer"] = {}
		return self._Faq_section&footer
	@Faq_section&footer.setter
	def Faq_section&footer(self, new_state):
		self._setter_access_tracker["Faq_section&footer"] = {}
		global default_state
		self._Faq_section&footer = Flex(new_state, default_state["Faq_section&footer"])
	...
	@property
	def trusted_by_text(self):
		self._getter_access_tracker["trusted_by_text"] = {}
		return self._trusted_by_text
	@trusted_by_text.setter
	def trusted_by_text(self, new_state):
		self._setter_access_tracker["trusted_by_text"] = {}
		global default_state
		self._trusted_by_text = TextBox(new_state, default_state["trusted_by_text"])
	...
	@property
	def s1(self):
		self._getter_access_tracker["s1"] = {}
		return self._s1
	@s1.setter
	def s1(self, new_state):
		self._setter_access_tracker["s1"] = {}
		global default_state
		self._s1 = Image(new_state, default_state["s1"])
	...
	@property
	def s2(self):
		self._getter_access_tracker["s2"] = {}
		return self._s2
	@s2.setter
	def s2(self, new_state):
		self._setter_access_tracker["s2"] = {}
		global default_state
		self._s2 = Image(new_state, default_state["s2"])
	...
	def service_text(self):
		self._getter_access_tracker["service_text"] = {}
		return self._service_text
	@service_text.setter
	def service_text(self, new_state):
		self._setter_access_tracker["service_text"] = {}
		global default_state
		self._service_text = Image(new_state, default_state["service_text"])

	@property
	def s_text1(self):
		self._getter_access_tracker["s_text1"] = {}
		return self._s_text1
	@s_text1.setter
	def s_text1(self, new_state):
		self._setter_access_tracker["s_text1"] = {}
		global default_state
		self._s_text1 = TextBox(new_state, default_state["s_text1"])

	@property
	def view_btn(self):
		self._getter_access_tracker["view_btn"] = {}
		return self._view_btn
	@view_btn.setter
	def view_btn(self, new_state):
		self._setter_access_tracker["view_btn"] = {}
		global default_state
		self._view_btn = Button(new_state, default_state["view_btn"])

	@property
	def project_heading(self):
		self._getter_access_tracker["project_heading"] = {}
		return self._project_heading
	@project_heading.setter
	def project_heading(self, new_state):
		self._setter_access_tracker["project_heading"] = {}
		global default_state
		self._project_heading = Image(new_state, default_state["project_heading"])
	...
	@property
	def gr_txt1(self):
		self._getter_access_tracker["gr_txt1"] = {}
		return self._gr_txt1
	@gr_txt1.setter
	def gr_txt1(self, new_state):
		self._setter_access_tracker["gr_txt1"] = {}
		global default_state
		self._gr_txt1 = Image(new_state, default_state["gr_txt1"])
	...
	@property
	def arrow_1(self):
		self._getter_access_tracker["arrow_1"] = {}
		return self._arrow_1
	@arrow_1.setter
	def arrow_1(self, new_state):
		self._setter_access_tracker["arrow_1"] = {}
		global default_state
		self._arrow_1 = Image(new_state, default_state["arrow_1"])
	...
	@property
	def blogs_heading(self):
		self._getter_access_tracker["blogs_heading"] = {}
		return self._blogs_heading
	@blogs_heading.setter
	def blogs_heading(self, new_state):
		self._setter_access_tracker["blogs_heading"] = {}
		global default_state
		self._blogs_heading = Image(new_state, default_state["blogs_heading"])
	...
	@property
	def white_arrrow(self):
		self._getter_access_tracker["white_arrrow"] = {}
		return self._white_arrrow
	@white_arrrow.setter
	def white_arrrow(self, new_state):
		self._setter_access_tracker["white_arrrow"] = {}
		global default_state
		self._white_arrrow = Image(new_state, default_state["white_arrrow"])
	...
	@property
	def date_time(self):
		self._getter_access_tracker["date_time"] = {}
		return self._date_time
	@date_time.setter
	def date_time(self, new_state):
		self._setter_access_tracker["date_time"] = {}
		global default_state
		self._date_time = TextBox(new_state, default_state["date_time"])

	@property
	def read_article(self):
		self._getter_access_tracker["read_article"] = {}
		return self._read_article
	@read_article.setter
	def read_article(self, new_state):
		self._setter_access_tracker["read_article"] = {}
		global default_state
		self._read_article = TextBox(new_state, default_state["read_article"])

	@property
	def whie_arrow(self):
		self._getter_access_tracker["whie_arrow"] = {}
		return self._whie_arrow
	@whie_arrow.setter
	def whie_arrow(self, new_state):
		self._setter_access_tracker["whie_arrow"] = {}
		global default_state
		self._whie_arrow = Image(new_state, default_state["whie_arrow"])
	...
	@property
	def product_heading(self):
		self._getter_access_tracker["product_heading"] = {}
		return self._product_heading
	@product_heading.setter
	def product_heading(self, new_state):
		self._setter_access_tracker["product_heading"] = {}
		global default_state
		self._product_heading = Image(new_state, default_state["product_heading"])
	...
	def footer_link(self):
		self._getter_access_tracker["footer_link"] = {}
		return self._footer_link
	@footer_link.setter
	def footer_link(self, new_state):
		self._setter_access_tracker["footer_link"] = {}
		global default_state
		self._footer_link = TextBox(new_state, default_state["footer_link"])
	...
	def _to_json_fields(self):
		return {
			"main_container": self._main_container,
			...
			"Trusted_by_heading": self._Trusted_by_heading,
			"Flex_trust": self._Flex_trust,
			"Flex14": self._Flex14,
			"service_wrapper": self._service_wrapper,
			"service_text2": self._service_text2,
			"Div3": self._Div3,
			"Flex18": self._Flex18,
			"Flex19": self._Flex19,
			"Flex20": self._Flex20,
			...
			"Flex25": self._Flex25,
			"Flex27": self._Flex27,
			"service_text1": self._service_text1,
			"project_wrapper": self._project_wrapper,
			"project_text": self._project_text,
			"image_projects": self._image_projects,
			"Div8": self._Div8,
			"Div10": self._Div10,
			"Div13": self._Div13,
			"title_projects": self._title_projects,
			"Flex37": self._Flex37,
			"Div9": self._Div9,
			"Flex36": self._Flex36,
			"Div15": self._Div15,
			...
			"Div16": self._Div16,
			"Flex39": self._Flex39,
			"blogs_section": self._blogs_section,
			"blog_box": self._blog_box,
			"Div18": self._Div18,
			"view_all_box": self._view_all_box,
			"right_box": self._right_box,
			"rightbox_1": self._rightbox_1,
			"read_box": self._read_box,
			"Flex56": self._Flex56,
			"Flex55": self._Flex55,
			"Flex60": self._Flex60,
			"Flex59": self._Flex59,
			...
			"Flex69": self._Flex69,
			"Flex68": self._Flex68,
			"arrow_box": self._arrow_box,
			"Flex44": self._Flex44,
			"right_arrow_box": self._right_arrow_box,
			"left_arrow_box": self._left_arrow_box,
			"about_section_1": self._about_section_1,
			"abot_div": self._abot_div,
			"about_text": self._about_text,
			"left_about": self._left_about,
			"about_1_right": self._about_1_right,
			"Flex67": self._Flex67,
			"Div27": self._Div27,
			"Div28": self._Div28,
			"Flex71": self._Flex71,
			...
			"Faq_section&footer": self._Faq_section&footer,
			"Div76": self._Div76,
			...
			"Image4": self._Image4,
			"Image5": self._Image5,
			"trusted_by_text": self._trusted_by_text,
			"Image": self._Image,
			"Image7": self._Image7,
			"Image3": self._Image3,
			"Image9": self._Image9,
			...
			"service_text": self._service_text,
			"s_text1": self._s_text1,
			"view_btn": self._view_btn,
			"project_heading": self._project_heading,
			...
			"gr_txt1": self._gr_txt1,
			"TextBox30": self._TextBox30,
			"arrow_1": self._arrow_1,
			...
			"product_heading": self._product_heading,
