...
const desktopModeProps = {
  ...
  "Home": {
    ...
    "project_heading": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/project_heading.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "blogs_heading": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/blogs_heading.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "product_heading": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/product_designer.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "TextBox133": {
      "custom": {
        "text": "BSc in computer engineering"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image75": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/testimonials_heading.png"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image80": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/white_angular_left.svg"
      },
      "callbacks": {
        "onClick": [
          {
    ...
    "Image82": {
      "custom": {
        "alt": "No preview available",
        "src": "/app-assets/white%20angular_right.svg"
      },
      "callbacks": {
        "onClick": [
          {
